    ...
    <div className="bg-[#050505] text-white overflow-x-hidden font-sans selection:bg-blue-500/30">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 px-4 md:px-12 border-b border-white/5 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 md:gap-16">
          ...
          >
            <div className="relative rounded-2xl md:rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-blue-900/20 group aspect-video lg:aspect-square">
            ...
            >
              {features.map((feature, idx) => (
                ...
                >
                  ...
                  <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-white group-hover:text-blue-500 transition-colors">
                    {feature.title}
                  </h3>
      ...
      <section className="py-20 md:py-32 px-4 md:px-6">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <button className="bg-white text-blue-900 px-8 py-3 md:px-10 md:py-4 rounded-full font-bold text-base md:text-lg hover:bg-gray-100 transition-colors shadow-xl w-full sm:w-auto">
              Get A Free Quote
            </button>
          </div>
        </motion.div>
